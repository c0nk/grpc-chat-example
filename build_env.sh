...
export GRPC_PYTHON_PLUGIN=$GRPC_ROOT/bins/opt/grpc_python_plugin
...
export PYGRPC_ROOT=$GRPC_ROOT/src/python/grpcio
export PYTHONPATH=$PYGRPC_ROOT:$GRPC_ROOT/third_party/protobuf/python
